...
export const siteConfig = {
  siteName: process.env.NEXT_PUBLIC_SITE_NAME || '민지 (Minji)3',
  siteNameEn: process.env.NEXT_PUBLIC_SITE_NAME_EN || 'Minji2',
  ...
  primaryColor: process.env.NEXT_PUBLIC_PRIMARY_COLOR || '#22d3ee',
  cardStyle: (process.env.NEXT_PUBLIC_CARD_STYLE || 'neon') as CardStyle,
